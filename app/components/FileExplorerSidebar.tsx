...
import { ChevronLeft, ChevronRight, ChevronDown, Plus, Upload, File, Diamond, Folder, FolderOpen } from 'lucide-react'
...
export function FileExplorerSidebar({ 
    ...
    const toggleFolder = usePlaygroundStore(({ toggleFolder }) => toggleFolder)
        ...
        return files.map((file) => (
            <div key={file.name}>
                <div
                    ...
                    onClick={() => file.type === 'folder' ? toggleFolder(file.name) : setSelectedFile(file)}
                >
                    {file.type === 'folder' && (
